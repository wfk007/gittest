/** layui-v2.2.5 MIT License By https://www.layui.com */ layui.define(
  "jquery",
  function(i) {
    "use strict";
    var t = layui.$,
    ...
    (s.prototype.set = function(i) {
      ...
      (s.prototype.tabAdd = function(i, a) {
        ...
        return (
          ...
          o.append(
            '<div class="layui-tab-item">' + (a.content || "") + "</div>"
          ),
          y.hideTabMore(!0),
          y.tabAuto(),
          this
        ...
        tabAuto: function() {
          ...
          t(".layui-tab").each(function() {
            var s = t(this),
              ...
              c = (s.children(".layui-tab-content").children(".layui-tab-item"),
              'lay-stope="tabmore"'),
              r = t(
            ...
            if (
              (n === window && 8 != a.ie && y.hideTabMore(!0),
              ...
              v = function(l, o, c) {
                ...
                o.hasClass(u)
                  ...
                  : (y.addClass(f),
                    ...
                    clearTimeout(p[c]),
                    "block" === y.css("display") && clearTimeout(s[c]),
              ...
              l.find("." + r)[0] ||
                ...
                f.each(function() {
                  ...
                  i.off("click", y.clickThis).on("click", y.clickThis),
                    i
                      .children("a")
                      .off("click", y.showChild)
                      .on("click", y.showChild),
                    a
                      .children("dd")
                      .off("click", y.clickChild)
                      .on("click", y.clickChild);
                });
            });
          },
          breadcrumb: function() {
